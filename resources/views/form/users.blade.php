...
<section class="container mt-4">
    <form action="{{ url('/users') }}" method="POST">
        @csrf
        <div class="mb-3">
            <label for="name" class="form-label text-start d-block">Name <span style="color: red">*</span></label>
        ...
        <div class="mb-3">
            <label for="email" class="form-label text-start d-block">Email <span style="color: red">*</span></label>
        ...
        <div class="mb-3">
            <label for="password" class="form-label text-start d-block">Password <span style="color: red">*</span></label>
